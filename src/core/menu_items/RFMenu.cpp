...
void RFMenu::optionsMenu() {
    options = {
        ...
        {"SubGHz Custom",   sendCustomRF              },
#endif
        {"Espectro",        rf_spectrum               },
#if !defined(LITE_VERSION)
        {"Espectro RSSI",   rf_CC1101_rssi            }, // @Pirata
        {"Espectro Onda Quad", rf_SquareWave             }, // @Pirata
...
#endif
        {"Força bruta",      rf_bruteforce             }, // dev_eclipse
...
void RFMenu::configMenu() {
    options = {
        {"Pino TX do RF", lambdaHelper(gsetRfTxPin, true)},
        {"Pino RX do RF", lambdaHelper(gsetRfRxPin, true)},
        {"Módulo RF", setRFModuleMenu},
        {"Frequência RF", setRFFreqMenu},
